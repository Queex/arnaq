...
membership) is typically available outside R, and as such ARNAQ reads files for this
information, which can either be generated as part of a pipeline or adapted from existing files by
hand.
...
Full installation and post-installation instructions can be found at
...
- **genome_reference**: the directory name containing the `.gtf` file with gene definitions.
...
using a proxy service (although the service does not support all html features used in the reports):

- [Full report](https://htmlpreview.github.io/?https://github.com/Queex/arnaq/blob/main/vignettes/GSE155423-arnaq.html)
- [Report on a subset of samples](https://htmlpreview.github.io/?https://github.com/Queex/arnaq/blob/main/vignettes/GSE155423-D10-D15-wo-outliers-arnaq.html)
- [Report with alternative PCA](https://htmlpreview.github.io/?https://github.com/Queex/arnaq/blob/main/vignettes/GSE155423-alt-PCA-arnaq.html)
- [Report with linear normalisation](https://htmlpreview.github.io/?https://github.com/Queex/arnaq/blob/main/vignettes/GSE155423-linear-arnaq.html)
- [Report with sample-to-sample scatterplots](https://htmlpreview.github.io/?https://github.com/Queex/arnaq/blob/main/vignettes/GSE155423-scatter-arnaq.html)

## Versions

Version numbering follows the Bioconductor pattern, where even minor version numbers are a release
version and odd minor version numbers indicate a development version. Major version is incremented
when the `resources.yml` format changes, or the report template changes.
